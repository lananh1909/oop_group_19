...
public class ProcessChartIndex {
    ...
    public XYChart.Series<String, Double> drawChartIndex(String floor){
        ...
        if(floor.contains("HNX") || floor.contains("UPCOM")){
            ...
            XYChart.Data<String, Double> day6 = new XYChart.Data<>("26", dataHNXModels.get(4).getExchangeValue());
            XYChart.Data<String, Double> day7 = new XYChart.Data<>("27", dataHNXModels.get(4).getExchangeValue());
            ...
            XYChart.Data<String, Double> day6 = new XYChart.Data<>("26", dataModels.get(4).getExchangeValue3());
            XYChart.Data<String, Double> day7 = new XYChart.Data<>("27", dataModels.get(4).getExchangeValue3());
